...
# 更新日志
<h3 id="INHAC">v8.1.6（2025.08.12）热更新</h3>

1. 优化OC[插入方法]，新增对self的引用
2. 优化OC[修改字符串]，新增数据类型变换，适配.mm文件
3. 修复OC[修改控制流]，条件外部包含取反操作时的逻辑错误，以及对switch case的处理
4. 优化OC[修改局部变量]，新增对只读属性的引用
