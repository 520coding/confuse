...
# 更新日志
<h3 id="INHAC">v8.2.4（2026.01.21）热更新</h3>

1. 修复Swift[拆分方法]，关系运算符结尾+注释的问题
2. 优化Swift[插入局部变量]，方法多行问题
3. 修复Swift[重命名属性]，@propertyWrapper的类属性问题
4. 优化Swift[重命名属性]，支持SmartCodableX
5. 优化OC[重命名类]，避免相似名称
6. 修复OC混淆后有可能死循环问题
