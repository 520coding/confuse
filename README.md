...
2. Optimized Swift [Rename Attributes], as follows:
   1. If the model mapping does not comply with a specific protocol, it will not be added actively
   2. Calculated attributes do not participate in model mapping
   3. The same name problem of maskView and OC bridge attributes
