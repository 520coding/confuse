...
1. [Rename picture], intelligent noun replacement, automatically process binary sks files, automatically correct the situation that the picture name and the xcassets folder name do not correspond
...
1. Strengthen the renaming of pictures, and support the synchronous modification of binary files sks
2. Optimize OC macro expansion and support NerdyUI
3. Optimize OC [modification method] to avoid infinite loop caused by actual parameter reference
