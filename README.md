...
# Update log
<h3 id="L8Epu">v8.3.1 (2026.02.26) Hot Update</h3>

1. Added Swift [Modify Property], supporting modifications to lazy properties
2. Optimize Swift for inserting local variables, handling multi-line and multi-parameter issues
3. Fix Swift type parsing errors for specific types
