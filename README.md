...
# Update log
<h3 id="L8Epu">v8.0.8 (2025.03.16) hot update</h3>

1. Adapt to the new version of Xcode, the system type extension part cannot be recognized
2. Optimize Swift [insert picture], the insertion position is unreasonable when the code is called in a line break
3. Optimize OC template code, isMemberOfClass class cluster judgment problem
