...
# Update log
<h3 id="L8Epu">v8.0.5 (2024.12.15) hot update</h3>

1. Strengthen OC [modify control flow] and expand changes
2. Fix OC [rename method], @selector missing modification problem in class method
3. Simplify the log output of rename series
