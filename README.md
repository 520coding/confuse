...
1. [修改文件属性]，如创建时间、访问时间、修改时间
1. [修改项目]，无需删除Cocoapods
   1. 可设置‘修改uuid’，彻底翻新
...
1. 移除部分非必要缓存，防止大项目中暂用过多内存
1. 新增C++[重命名方法]测试版，近似Xcode的Rename功能
   1. 语法相关，识别类型、模板、继承关系
   1. 【智能名词替换】，混淆后不同类存在相同方法名，模拟正常开发
   1. 【智能识别不可修改部分】，不放过任何一个可以修改的内容
3. APP界面更新，新增日志手动刷新，更新菜单栏，新增主动停止检查
