...
# Update log
<h3 id="L8Epu">v8.1.2 (2025.07.20) hot update</h3>

1. Enhance OC [Modify String], add new strategy selection
2. Fix Swift [Modify Control Flow], adapt to more situations
3. Fix Swift [Rename Property], protocol extension property modification is not synchronized
4. Fix Swift [Rename Method], protocol extension method modification is not synchronized
