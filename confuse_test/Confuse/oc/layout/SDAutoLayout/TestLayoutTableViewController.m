...
- (void)viewDidLoad
{
    ...
    [self.navigationController pushViewController:[NSClassFromString(@"TestLayoutViewController") new] animated:YES];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    TestLayoutCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) {
        cell = [[TestLayoutCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
    }
