...
class Test2ViewController: UIViewController, UITableViewDelegate {
  // MARK: - Variables
...
fileprivate extension Selector {
  static let updateMainTimer = #selector(Test2ViewController.updateMainTimer)
  static let updateLapTimer = #selector(Test2ViewController.updateLapTimer)
}
